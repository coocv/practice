...
如上两行代码运行结果为:![](images/day1_img3.png)
...
- 子类使用super关键字访问父类的方法
  ...
  **注意:**
  ...
  5. 在 ES6 中类没有变量提升，所以必须先定义类，才能通过类实例化对象![](images/day1_img2.png)
...
![](images/day2_img2.png)

![](images/day2_img3.png)
...
![](images/day2_img8.png)如果未设置constructor属性,如图:

![](images/day2_img9.png)

### 4.7原型链

​ 每一个实例对象又有一个__proto__属性，指向的构造函数的原型对象，构造函数的原型对象也是一个对象，也有__proto__属性，这样一层一层往上找就形成了原型链。

![](images/day2_img5.png)
...
![](images/day4_img2.png)

![](images/day4_img1.png)
